      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {projects.map((project) => (
            <div 
              key={project.id} 
              className='bg-gradient-to-r from-purple-600 to-blue-500 p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 flex flex-col justify-between h-full'
            >
              <div>
                <img 
                  src={project.image} 
                ...
                <p className='text-sm text-slate-100 mb-4'>{project.description}</p>
              </div>
              <div className='mt-auto'>
                <a 
                  ...
                  className='flex items-center text-slate-100 hover:underline'
                >
